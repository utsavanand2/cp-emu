...
const (
	...
	MaxChargingPower string = "maxChargingPower"
)
...
func GetDefaultConfig() ConfigMap {
	...
	cfg[ChargeRate] = core.ConfigurationKey{Key: ChargeRate, Readonly: false, Value: newString("16")}
	cfg[MaxChargingPower] = core.ConfigurationKey{Key: MaxChargingPower, Readonly: true, Value: newString("22")}
	return cfg
}
